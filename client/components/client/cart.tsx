  ...
  return (
    <div>
      <button
        ...
        className="rounded-md bg-gray-950/5 px-2.5 py-1.5 text-sm font-semibold text-gray-900 hover:bg-gray-950/10 cursor-pointer"
      >
        Cart
      </button>
              ...
              >
                <div className="flex h-full flex-col overflow-y-auto bg-white shadow-xl">
                  ...
                  <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                    ...
                    <div className="mt-6">
                      {/* //! link or any other method to implement */}
                      <a
                        href="#"
